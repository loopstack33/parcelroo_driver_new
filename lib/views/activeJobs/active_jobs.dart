...
import 'package:parcelroo_driver_app/views/activeJobs/widgets/active_jobs_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: myText(text: "Active Jobs", fontFamily: "Poppins",fontWeight: FontWeight.w700, size: 24.sp, color: whiteColor),
          centerTitle: true,
        ),
        body: Padding(
                ...
                Center(
                  child:Column(
                    ...
                    children: [
                      ...
                      myText(text: "No Active Jobs Found", fontFamily: "Poppins", size: 25.sp, color:Colors.white),
                    ],
                  ),
                );
              }
