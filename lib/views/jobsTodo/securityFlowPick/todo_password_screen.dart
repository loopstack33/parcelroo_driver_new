...
class TodoPickPasswordScreen extends StatelessWidget {
  final AdvertiseModel advertiseModel;
  const TodoPickPasswordScreen({Key? key,required this.advertiseModel}) : super(key: key);
              ...
              children: [
                ...
                Padding(
                  ...
                  child: CustomTextField(
                      controller: context.read<JobsTodoProvider>().passController,
                ...
                MyFancyButton(
                    ...
                    family: "Poppins",
                    text: "Continue", tap: (){
                  if(context.read<JobsTodoProvider>().passController.text.isEmpty && context.read<JobsTodoProvider>().overrideController.text.isEmpty){
                    ...
                    if(context.read<JobsTodoProvider>().overrideController.text.isNotEmpty){
                      context.read<JobsTodoProvider>().checkPickOverPass(context,advertiseModel);
                    }
                    else{
                        context.read<JobsTodoProvider>().checkPickPass(context,advertiseModel);
                    }
                    }
                      },
