...
import 'package:parcelroo_driver_app/views/cancelledJobs/widgets/cancelledJobs_widget.dart';
...
import 'controller/cancelled_job_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: myText(text: "Cancelled Jobs", fontFamily: "Poppins",fontWeight: FontWeight.w700, size: 24.sp, color: whiteColor),
          centerTitle: true,
        ),
              ...
              children: [
                TableCalendar(
                  ...
                  selectedDayPredicate: (day) {
                    return isSameDay(context.read<CancelledJobController>().selectedDay, day);
                  },
                  onDaySelected: (selectedDay, focusedDay) {
                    context.read<CancelledJobController>().changeDay(selectedDay,focusedDay);
                  },
                ),
                StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance.collection('drivers').doc(Globals.uid).collection("cancelledJobs").where("pickDate",isEqualTo: DateFormat("dd-MM-yyyy").format(context.watch<CancelledJobController>().focusedDay)).snapshots(),
                      ...
                      Center(
                        child:Column(
                          ...
                          children: [
                            ...
                            myText(text: "No Cancelled Jobs Found", fontFamily: "Poppins", size: 25.sp, color:Colors.white),
                          ],
                        ),
                      );
                    }
